    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="teacherForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3"><label>Mobile Number</label>
                            <input type="text" name="mobile_number" class="form-control" required></div>
                        <div class="mb-3"><label>WhatsApp Number</label>
                            <input type="text" name="whatsapp_number" class="form-control"></div>
                        <div class="mb-3">
                            <label>Gender</label>
                        ...
                        <div class="mb-3"><label>Highest Qualification</label>
                            <input type="text" name="highest_qualification" class="form-control"></div>
                        <div class="mb-3"><label>Total Experience (Years)</label>
                            <input type="number" name="total_experience" class="form-control"></div>
                        ...
                        <div class="mb-3"><label>Confirm Password</label>
                            <input type="password" name="password_confirmation" class="form-control" required minlength="6"></div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="mb-3"><label>Pin Code</label>
                            <input type="text" name="pin_code" class="form-control"></div>
                        <div class="mb-3">
                            <label>Allowed Language</label>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="language[]" value="hindi" id="lang_hindi">
                ...
                <div class="row">
                    ...
                    @foreach($questionTypes as $type)
                        <div class="col-md-4 mb-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input qtype-checkbox" id="qtype_{{ $loop->index }}" value="{{ $type }}" name="question_type_permission[]">
                            ...
                            <div class="mt-2 pay-per-question" style="display:none;">
                                ...
                                <input type="number" name="pay_per_question[{{ $type }}]" class="form-control" min="0" placeholder="Enter amount">
                            </div>
                        </div>
                    @endforeach
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3"><label>UPI ID</label><input type="text" name="upi_id" class="form-control"></div>
                        <div class="mb-3"><label>Account Name</label><input type="text" name="account_name" class="form-control"></div>
                        <div class="mb-3"><label>Account Number</label><input type="text" name="account_number" class="form-control"></div>
                        <div class="mb-3"><label>Confirm Account Number</label><input type="text" name="confirm_account_number" class="form-control"></div>
                        <div class="mb-3"><label>Bank Name</label><input type="text" name="bank_name" class="form-control"></div>
                        <div class="mb-3"><label>Bank Branch</label><input type="text" name="bank_branch" class="form-control"></div>
                        <div class="mb-3"><label>IFSC Code</label><input type="text" name="ifsc_code" class="form-control"></div>
                        <div class="mb-3"><label>SWIFT Code</label><input type="text" name="swift_code" class="form-control"></div>
                        <div class="mb-3"><label>Upload Cancelled Cheque</label><input type="file" name="cancelled_cheque" class="form-control"></div>
                        <div class="mb-3"><label>Upload QR Code</label><input type="file" name="qr_code" class="form-control"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3"><label>PAN Card Number</label><input type="text" name="pan_number" class="form-control"></div>
                        <div class="mb-3"><label>Upload PAN Card Copy</label><input type="file" name="pan_file" class="form-control"></div>
                        <div class="mb-3"><label>Aadhar Card Number</label><input type="text" name="aadhar_number" class="form-control"></div>
                        <div class="mb-3"><label>Upload Aadhar Card (Front)</label><input type="file" name="aadhar_front" class="form-control"></div>
                        <div class="mb-3"><label>Upload Aadhar Card (Back)</label><input type="file" name="aadhar_back" class="form-control"></div>
                        <div class="mb-3"><label>Upload Profile Picture</label><input type="file" name="profile_picture" class="form-control"></div>
                        <div class="mb-3"><label>Upload Education Documents</label><input type="file" name="education_docs[]" class="form-control" multiple></div>
