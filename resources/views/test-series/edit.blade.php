...
<div class="bg-light rounded">
    <div class="card">
        <div class="card-body">
            ...
            <form id="test-form" method="POST" action="{{ route('test.series.update',$test_series->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                       ...
                       <div class="col-md-6 sub-cat" {{$test_series->sub_category_id !='' ? 'hidecls' : ''}}>
                        ...
                        <select id="sub_category_id" name="sub_category_id"><option value="">--Select--</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="title" id="title" value="{{$test_series->title}}" placeholder="Title" required>
                            <div class="text-danger validation-err" id="title-err"></div>
                        </div>
                        <div class="col-md-6">
                            <label for="title" class="form-label">Slug</label>
                            <input type="text" class="form-control" name="slug"  value="{{$test_series->slug}}" id="slug" placeholder="Slug" required>
                        ...
                        <div class="col-md-6" id="discount-div" @if($test_series->fee_type == 'free') style="display:none;" @endif>
                            <label for="discount" class="form-label">Discount (%):</label>
                            <input type="number" class="form-control" id="discount" value="{{$test_series->discount}}" name="discount" >
                            <div class="text-danger validation-err" id="discount-err"></div>
                        </div>
                        <div class="col-md-6" id="price-div" @if($test_series->fee_type == 'free') style="display:none;" @endif>
                            <label for="offered-price" class="form-label">Offered Price:</label>
                        
                                <input type="text" class="form-control" id="offered-price" name="price" value="{{$test_series->price}}" readonly>
           ...
           {{--     <div class="mb-3">
                    ...
                    <input type="number" class="form-control" value="{{$test_series->total_chapter}}" name="total_chapter" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" value="{{$test_series->total_subjects}}" name="total_subjects" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" value="{{$test_series->total_affairs}}" name="total_affairs" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" value="{{$test_series->free_tests}}" name="free_tests" required>
          ...
          {{--      <div class="mb-3">
                    ...
                    <input type="number" class="form-control" value="{{$test_series->total_marks}}" name="total_marks" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="duration" value="{{$test_series->total_marks}}" placeholder="ex: 120 Minutes" required>
                ...
                <div class="col-md-12">
                  ...
                  <textarea class="form-control editor" id="short_description"  name="short_description">{{$test_series->short_description}}</textarea>
                </div>
                <div class="col-md-12">
                    <label for="description" class="form-label">Content</label>
                    <textarea class="form-control editor" id="content" name="description">{{$test_series->description}}</textarea>
                                        ...
                                        <div class="row question-row">
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control test_type" name="type[]">
                                                    ...
                                                    <option value="1" @if(isset($test_series_details[0]) && $test_series_details[0]->type == 1) selected @endif>Full Test</option>
                                                    <option value="2" @if(isset($test_series_details[0]) && $test_series_details[0]->type == 2) selected @endif>Subject Wise</option>
                                                    <option value="3" @if(isset($test_series_details[0]) && $test_series_details[0]->type == 3) selected @endif>Chapter Wise</option>
                                                    <option value="4" @if(isset($test_series_details[0]) && $test_series_details[0]->type == 4) selected @endif>Topic Wise</option>
                                                    <option value="5" @if(isset($test_series_details[0]) && $test_series_details[0]->type == 5) selected @endif>Current Affair</option>
                                                    <option value="6" @if(isset($test_series_details[0]) && $test_series_details[0]->type == 6) selected @endif>Previous Year</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <select id="test_generated_by" name="test_generated_by" class="form-control test_generated_by">
                                                    <option value="">Choose...</option>
                                                    <option value="manual" @if($test_series->test_generated_by == "manual") selected @endif>Manual</option>
                                                    <option value="random" @if($test_series->test_generated_by == "random") selected @endif>Random</option>
                                                </select>
                                            </div>
                                            
                                            <div class="col-md-4">
                                                <label for="title" class="form-label">No. of Paper</label>
                                                <input type="text" class="form-control total_paper" name="total_paper" placeholder="No. of Paper" value="{{$test_series->total_paper}}" required>
                                            </div>
                                                            ...
                                                            <li id="customquestionli">
                                                                <label>
                                                                    <span class="questn-he">
                                                                        <input type="checkbox" name="question[]" class="question" value="{!! $testDetail->test_id !!}">
                                                                        <span class="question-text">{!! $testDetail->test->name ?? "" !!}</span>
                                                                    </span>
                                            ...
                                            <div class="col-md-5">
                                                <div class="box-area-questions">
                                                    ...
                                                    <div class="box-questns">
                                                        <ul class="selected-questions customquestionselectedbox-passage" id="customquestionselectedbox-passage">
                                                            @if(isset($test_series_details) && count($test_series_details) > 0)
                                                            @foreach($test_series_details as $testDetail)
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <div class="button-actns-questn">
                                                    <button class="btn btn-primary addquestiontoselected-passage" type="button" fdprocessedid="49r4zxe"><i class="fa fa-arrow-left"></i></button>
                                                    <i class="fa fa-exchange"></i>
                                                    <button class="btn btn-danger removequestionfromselected-passage" type="button" fdprocessedid="2x8rl7"><i class="fa fa-arrow-right"></i></button>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="box-area-questions">
                                                    <h4>Passage Test Papers <span id="questioncountshow"></span></h4>
                                                    <div class="box-questns">
                                                        <ul class="customquestionbox-passage" id="customquestionbox-passage">
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="box-area-questions">
                                                    <h4>Your Tests <span id="questioncountsubjectiveshow"></span></h4>
                                                    <div class="box-questns">
                                            ...
                                            <div class="col-md-5">
                                                <div class="box-area-questions">
                                                    <h4>Subjective Test Papers <span id="questioncountshow"></span></h4>
                                                    <div class="box-questns">
                                            ...
                                            <div class="col-md-5">
                                                <div class="box-area-questions">
                                                    ...
                                                    <div class="box-questns">
                                                        <ul class="selected-questions customquestionselectedbox-combined" id="customquestionselectedbox-combined">
                                                            @if(isset($test_series_details) && count($test_series_details) > 0)
                                                            @foreach($test_series_details as $testDetail)
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <div class="button-actns-questn">
                                                    <button class="btn btn-primary addquestiontoselected-combined" type="button" fdprocessedid="49r4zxe"><i class="fa fa-arrow-left"></i></button>
                                                    <i class="fa fa-exchange"></i>
                                                    <button class="btn btn-danger removequestionfromselected-combined" type="button" fdprocessedid="2x8rl7"><i class="fa fa-arrow-right"></i></button>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="box-area-questions">
                                                    <h4>Combined Test Papers <span id="questioncountshow"></span></h4>
                                                    <div class="box-questns">
                                                        <ul class="customquestionbox-combined" id="customquestionbox-combined">
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
...
$(document).on('click', '.addquestiontoselected-passage', function(event) {
    ...
    $('.slide-menu-passage').append(testTemp);

    const selectedCount = questionRow.find(".customquestionselectedbox-passage .question").length;
    // questionRow.find("#questioncountpassageshow").text(`(${selectedCount}/${total})`);
});
...
$(document).on('click', '.addquestiontoselected-subjective', function(event) {
    ...
    $('.slide-menu-subjective').append(testTemp);

    const selectedCount = questionRow.find(".customquestionselectedbox-subjective .question").length;
    // questionRow.find("#questioncountsubjectiveshow").text(`(${selectedCount}/${total})`);
});
...
$(document).on('click', '.addquestiontoselected-combined', function(event) {
    ...
    $('.slide-menu-combined').append(testTemp);

    const selectedCount = questionRow.find(".customquestionselectedbox-combined .question").length;
    // questionRow.find("#questioncountcombinedshow").text(`(${selectedCount}/${total})`);
});
