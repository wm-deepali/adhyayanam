        ...
        <tr>
            ...
            <td>
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{route('teacher.question.bank.view',$data->id)}}"><i class="fas fa-eye"></i> View</a></li>
                <li><a class="dropdown-item" href="{{route('teacher.question.bank.edit',$data->id)}}"><i class="fas fa-edit"></i> Edit</a></li>
                <li>
