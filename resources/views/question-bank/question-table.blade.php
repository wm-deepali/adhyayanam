        ...
        @foreach($questionBanks as $data)
            <tr>
                ...
                <td>{{$data->topics->name ?? "_"}}<br /><span
                        class="badge badge-secondary">{{$data->subject->name ?? "-"}}</span></td>
                <td><span class="text-success">{{$data->category->name ?? "-"}}</span><br /><span
                        class="text-warning">{{$data->subcategory->name ?? "-"}}</span></td>
