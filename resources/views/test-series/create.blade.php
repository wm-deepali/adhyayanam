                                        ...
                                        <div class="row question-row">
                                            ...
                                            <div class="col-md-5">
                                                <div class="box-area-questions">
                                                    ...
                                                    <div class="box-questns">
                                                        <ul class="selected-questions customquestionselectedbox-passage" id="customquestionselectedbox-passage"></ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-md-5">
                                                <div class="box-area-questions">
                                                    ...
                                                    <div class="box-questns">
                                                        <ul class="selected-questions customquestionselectedbox-combined" id="customquestionselectedbox-combined"></ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
