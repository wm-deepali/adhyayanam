        ...
        <div class="center-card" style="width:100%; height:auto;">
            ...
            <div class="form-row" >
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Test Duration" name="duration" id="duration">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" placeholder="Enter in no." name="total_questions" id="total_questions" >
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" placeholder="Enter in no." name="total_marks" id="total_marks" >
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-2">
                    <input type="number" id="mcq_total_question" name="mcq_total_question" value="0" placeholder="Total Question MCQ" readonly>
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="mcq_mark_per_question" name="mcq_mark_per_question" value="0" placeholder="Each Question Marks MCQ" readonly>
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="mcq_total_marks" name="mcq_total_marks" value="0" placeholder="Total Marks MCQ" readonly>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <input type="checkbox" id="question-type-story" name="question_type[]" value="Story Based">
                    <label for="question-type-story"> Story Based</label><br>
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="story_total_question" name="story_total_question" value="0" placeholder="Total Question Story" readonly>
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="story_mark_per_question" name="story_mark_per_question" value="0" placeholder="Each Question Marks Story" readonly>
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="story_total_marks" name="story_total_marks" value="0" placeholder="Total Marks Story" readonly>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <input type="checkbox" id="question-type-subjective" name="question_type[]" value="Subjective">
                        <label for="question-type-subjective"> Subjective</label><br>
                    
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="subjective_total_question" name="subjective_total_question" value="0" placeholder="Total Question Subjective" readonly>
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="subjective_mark_per_question" name="subjective_mark_per_question" value="0" placeholder="Each Question Marks Subjective" readonly>
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="subjective_total_marks" name="subjective_total_marks" value="0" placeholder="Total Marks Subjective" readonly>
                </div>
            </div>
            <div class="form-row">
                <!--div class="form-group col-md-4">
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    <label for="text">Test Instructions (If Any)</label>
                        <textarea style="height:150px" id="test_instruction" name="test_instruction" class="form-control" id="exampleFormControlTextarea1" rows="4"></textarea>
    ...
    <div class="col-sm-12">
        <div class="tab-pane-generated">
            <div class="tab-content px-1 pt-1">
                <div class="tab-pane mcq-tab active" id="mcq-tab" role="tabpanel" aria-labelledby="base-mcq" style="display:none;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="box-area-questions">
                                    <h4>Your Questions(MCQ) <span id="questioncountmcqshow"></span></h4>
                 ...
                 <div class="tab-pane story-tab active" id="story-tab" role="tabpanel" aria-labelledby="base-story" style="display:none;">
                    <div class="customquestiondiv">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="box-area-questions">
                                    <h4>Your Questions(Story Based) <span id="questioncountstoryshow"></span></h4>
                                    <div class="box-questns">
                                        <ul class="selected-questions customquestionselectedbox-story" id="customquestionselectedbox-story"></ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-2">
                ...
                <div class="tab-pane subjective-tab active" id="subjective-tab" role="tabpanel" aria-labelledby="base-subjective" style="display:none;"> 
                    <div class="customquestiondiv">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="box-area-questions">
                                    <h4>Your Questions(Subjective) <span id="questioncountsubjectiveshow"></span></h4>
                                    <div class="box-questns">
                                        <ul class="selected-questions customquestionselectedbox-subjective" id="customquestionselectedbox-subjective"></ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-2">
