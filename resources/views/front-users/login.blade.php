      ...
      <div class="row g-0 login-card">
        ...
        <div class="col-lg-6 d-none d-lg-block">
          <div class="left-image">
            <div>
              <h2>Welcome Back</h2>
              <p>Login to continue your preparation journey with structured tests, daily boosters, and expert guidance.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="right-form">
            ...
            <form id="loginForm">
              ...
              <input type="hidden" id="redirect_url" value="{{ request('redirect', session('url.intended')) }}">
              ...
              <div class="input-group mb-3">
                ...
                <input type="tel" class="form-control" id="mobile" placeholder="Enter 10-digit number" maxlength="10"
      ...
      $.ajax({
        ...
        success: function (result) {
          ...
          if (result.success) {
            ...
            let redirectUrl = result.redirect_url || $('#redirect_url').val();
            ...
            Swal.fire({
              icon: 'error',
              title: 'Invalid OTP',
              text: result.message || 'Please enter a valid OTP.'
            });
