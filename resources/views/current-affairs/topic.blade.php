                    ...
                    <tbody>
                        @foreach($topics as $topic)
                            <tr>
                                ...
                                <td>{{ $topic->name }}</td>
                                <td>{{ \Illuminate\Support\Str::limit($topic->description, 50) }}</td>
                                <td>{{ $topic->creator ? $topic->creator->name : 'Super Admin'  }}</td>
                            ...
                            <div class="modal fade" id="editTopicModal{{ $topic->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form method="POST" action="{{ route('current.affairs.topic.update', $topic->id) }}">
                                            @csrf
                                            @method('PUT')
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="editTopicModalLabel{{ $topic->id }}">Edit
                                                    Category</h5>
