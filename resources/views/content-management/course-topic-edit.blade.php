            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('topic.update', $topic->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 sub-cat hidecls">
                        ...
                        <select class="form-select" name="sub_category_id" id="sub_category_id">
                            @foreach($subcategories as $subcategory)
                                <option @if($topic->sub_category_id == $subcategory->id) selected @endif
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Name" value="{{$topic->name}}"
                            required>
                        @if ($errors->has('name'))
...
<script>
    $(document).ready(function () {
        ...
        let existingSubCategory = "{{ $topic->sub_category_id }}";
