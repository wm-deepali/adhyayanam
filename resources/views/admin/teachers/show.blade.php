...
<div class="card mt-3">
    <div class="card-header">
        <h3>Teacher Profile: {{ $teacher->full_name }}</h3>
        <a href="{{ route('manage-teachers.index') }}" class="btn btn-secondary btn-sm float-end">Back to List</a>
    </div>
    <div class="card-body">
        <dl class="row">
            ...
            <dd class="col-sm-9">
                ...
                <br>
                Subjective: {{ $teacher->allow_subjective ? 'Yes' : 'No' }} (₹{{ number_format($teacher->pay_per_subjective, 2) }})
                <br>
