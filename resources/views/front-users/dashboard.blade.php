				...
				<div class="col-xl-3 col-12">
					<div class="box bg-transparent no-shadow">
						<div class="box-body p-xl-0 text-center">							
							...
							<a href="https://netiias.com/design/courses.html" class="waves-effect waves-light w-p100 btn btn-primary"><i class="fa fa-plus me-15"></i> Create New Course</a>
						</div>
					</div>
					<div class="row">
						<div class="col-6">
								...
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										...
										<div class="d-flex flex-column fw-500">
											<a href="https://netiias.com/design/courses.html" class="text-dark hover-warning mb-1 fs-16">UPSC</a>
											<span class="text-fade">30+ Courses</span>
										</div>
									</div>
									
									<div class="d-flex align-items-center">
										<a href="https://netiias.com/design/courses.html" class="waves-effect waves-light btn btn-sm btn-warning-light me-10">View Courses</a>
										<div class="dropdown">
							...
							<div class="box-body">
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										...
										<div class="d-flex flex-column fw-500">
											<a href="https://netiias.com/design/courses.html" class="text-dark hover-danger mb-1 fs-16">UPPCS</a>
											<span class="text-fade">25+ Courses</span>
										</div>
									</div>
									
									<div class="d-flex align-items-center">
										<a href="https://netiias.com/design/courses.html" class="waves-effect waves-light btn btn-sm btn-danger-light me-10">View Courses</a>
										<div class="dropdown">
											<a class="px-10 pt-5" href="#" data-bs-toggle="dropdown"><i class="fa fa-ellipsis-v"></i></a>
											<div class="dropdown-menu dropdown-menu-end">
											  <a class="dropdown-item flexbox" href="#">Apply</a>
							...
							<div class="box-body">
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										...
										<div class="d-flex flex-column fw-500">
											<a href="https://netiias.com/design/courses.html" class="text-dark hover-success mb-1 fs-16">BPSC</a>
											<span class="text-fade">30+ Courses</span>
										</div>
									</div>
									
									<div class="d-flex align-items-center">
										<a href="https://netiias.com/design/courses.html" class="waves-effect waves-light btn btn-sm btn-success-light me-10">View Courses</a>
										<div class="dropdown">
											<a class="px-10 pt-5" href="#" data-bs-toggle="dropdown"><i class="fa fa-ellipsis-v"></i></a>
											<div class="dropdown-menu dropdown-menu-end">
											  <a class="dropdown-item flexbox" href="#">Apply</a>
							...
							<div class="box-body">
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										...
										<div class="d-flex flex-column fw-500">
											<a href="https://netiias.com/design/courses.html" class="text-dark hover-primary mb-1 fs-16">SSC</a>
											<span class="text-fade">50+ Courses</span>
										</div>
									</div>
									
									<div class="d-flex align-items-center">
										<a href="https://netiias.com/design/courses.html" class="waves-effect waves-light btn btn-sm btn-primary-light me-10">View Courses</a>
										<div class="dropdown">
											<a class="px-10 pt-5" href="#" data-bs-toggle="dropdown"><i class="fa fa-ellipsis-v"></i></a>
											<div class="dropdown-menu dropdown-menu-end">
											  <a class="dropdown-item flexbox" href="#">Apply</a>
								...
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										<div class="me-15 mb-1">
											<img src="{{ url('src/images/avatar/avatar-1.png')}}" class="bg-primary-light avatar avatar-lg rounded-circle" alt="">
										</div>
										<div class="d-flex flex-column fw-500">
									...
									<div class="d-flex align-items-center">
										<a href="https://netiias.com/design/test-series.html" class="waves-effect waves-light btn btn-sm btn-secondary">Courses</a>	
									</div>
								</div>
							</div>
						</div>
						<div class="box mb-15 pull-up">
							<div class="box-body">
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										<div class="me-15 mb-1">
											<img src="{{ url('src/images/avatar/avatar-2.png')}}" class="bg-primary-light avatar avatar-lg rounded-circle" alt="">
										</div>
										<div class="d-flex flex-column fw-500">
									...
									<div class="d-flex align-items-center">
										<a href="https://netiias.com/design/courses.html" class="waves-effect waves-light btn btn-sm btn-secondary">Courses</a>	
									</div>
								</div>
							</div>
						</div>
								...
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										<div class="me-15" style="margin-bottom: 1px;">
											<img src="{{ url('src/images/avatar/avatar-3.png')}}" class="bg-primary-light avatar avatar-lg rounded-circle" alt="">
										</div>
										<div class="d-flex flex-column fw-500">
						...
						<div class="box mb-15 pull-up">
							<div class="box-body">
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										<div class="me-15">
											<img src="{{ url('src/images/avatar/avatar-4.png')}}" class="bg-primary-light avatar avatar-lg rounded-circle" alt="">
										</div>
										<div class="d-flex flex-column fw-500">
							...
							<div class="box">
								<div class="box-header no-border">
									...
									<ul class="box-controls pull-right d-md-flex d-none">
									  <li>
										<a href="https://netiias.com/design/courses.html" class="btn btn-primary-light px-10 base-font">View All</a>
									  </li>
									</ul>
								</div>
								<div class="box-body">
								...
								<div class="box-body">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											...
											<div class="d-flex flex-column fw-500">
												<a href="https://netiias.com/design/courses.html" class="text-dark hover-primary mb-1 fs-16">UPSC Full Course</a>
								...
								<div class="box-body">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											...
											<div class="d-flex flex-column fw-500">
												<a href="https://netiias.com/design/courses.html" class="text-dark hover-primary mb-1 fs-16">Test Series</a>
								...
								<div class="box-body">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											...
											<div class="d-flex flex-column fw-500">
												<a href="https://netiias.com/design/courses.html" class="text-dark hover-primary mb-1 fs-16">Live Classes A</a>
								...
								<div class="box-body">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											...
											<div class="d-flex flex-column fw-500">
												<a href="https://netiias.com/design/courses.html" class="text-dark hover-info mb-1 fs-16">Quiz</a>
												<span class="text-fade">Micak Doe, 12 June</span>
											</div>
										</div>
										<a href="https://netiias.com/design/courses.html">
