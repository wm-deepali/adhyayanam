                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="form-control-plaintext">
                            {{ $dailyBooster->start_date ? date('d M Y', strtotime($dailyBooster->start_date)) : '--' }}</p>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        @if($dailyBooster->thumbnail)
                            <img src="{{ asset('storage/' . $dailyBooster->thumbnail) }}"
                                alt="{{ $dailyBooster->image_alt_tag ?? 'Thumbnail' }}" class="rounded border shadow-sm"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="form-control-plaintext">
                            {{ $dailyBooster->created_at ? $dailyBooster->created_at->format('d M Y, h:i A') : '--' }}</p>
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-bold">Updated At:</label>
                        <p class="form-control-plaintext">
                            {{ $dailyBooster->updated_at ? $dailyBooster->updated_at->format('d M Y, h:i A') : '--' }}</p>
                    </div>
                </div>
            </div>
        </div>
