...
<div class="bg-light rounded">
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('settings.header.store') }}" id="header-form" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="twitter_card" value="{{ $settings->twitter_card ?? '' }}">
                    @error('twitter_card')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="canonical_url" value="{{ $settings->canonical_url ?? '' }}">
                    @error('canonical_url')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    @if ($settings && $settings->company_logo)
                        <img src="{{ Storage::url($settings->company_logo) }}" alt="Company Logo" class="img-thumbnail mt-2" width="100">
                    @endif
                    @error('company_logo')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="whatsapp_number" value="{{ $settings->whatsapp_number ?? '' }}">
