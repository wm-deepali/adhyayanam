                ...
                <table class="table table-striped mt-5">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ asset('storage/' . $enquiry->file) }}" class="btn btn-primary" download>Download</a></td>
                            <td>
                                <form action="{{ route('enquiries.direct.delete', $enquiry->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
