...
<div class="bg-light rounded p-3">
    <div class="card">
        <div class="card-body">
            ...
            <button class="btn btn-primary mb-3 d-flex align-items-center" type="button" data-bs-toggle="collapse" data-bs-target="#bannerForm" aria-expanded="false" aria-controls="bannerForm">
            ...
            <table class="table table-striped mt-5">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$data->link}}</td>
                        <td>
                            <a href="{{route('settings.marquee.edit',$data->id)}}" class="btn btn-primary">Edit</a>
                            <form action="{{ route('settings.marquee.delete', $data->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
