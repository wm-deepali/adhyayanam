...
<div class="bg-light rounded p-3">
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('settings.popup.store') }}" enctype="multipart/form-data" id="popupForm">
                @csrf
                <div class="form-group">
                    <label>PopUp Image</label>
                    <input type="file" name="pop_image" class="form-control" id="popImageInput">
                    <img id="popImagePreview" src="{{isset($popUp) ? asset('storage/'.$popUp->pop_image):''}}" alt="Popup Image" style="max-width: 150px; margin-top:10px;">
                </div>
                <div class="form-group">
                    <label>Link</label>
