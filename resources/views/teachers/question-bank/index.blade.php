        ...
        <div class="card">
            <div class="card-body">
                ...
                <div id="question-container">
                    @include('teachers.question-bank.question-table')
                </div>
            </div>
        </div>
    </div>
