           ...
           <div class="question-bank-main-page">
            <input type="hidden" value="{{$paper->id}}" id="test_id">
               <div class="left-side" style="width:100%; height:auto; ">
                ...
                <div class="form-group previous-year-group" id="previous-year" @if($paper->paper_type != 1) style="display: none;" @endif>
                    <label>Previous Year</label>
                    <input type="number" class="form-control" name="previous_year" value="{{$paper->previous_year ?? ''}}"placeholder="Ex. 2014">
                </div>
                ...
                <select id="competitive_commission" name="competitive_commission">
                    ...
                    @if (isset($commissions) && count($commissions) > 0)
                        @foreach ($commissions as $commission)
                            <option @if($paper->competitive_commission_id == $commission->id) selected @endif value='{{ $commission->id }}'>
               ...
               <label class="mt-2" for="exam_category">Examination Category *</label>
                <select id="exam_category" name="exam_category">
                    ...
                    @foreach($categories as $category)
                        <option @if($paper->exam_category_id == $category->id) selected @endif value="{{ $category->id }}">{{ $category->name }}</option>
                    @endforeach
                </select>
                ...
                <select id="exam_subcategory" name="exam_subcategory">
                    ...
                    @foreach($subcategories as $subcategory)
                        <option @if($paper->exam_subcategory_id == $subcategory->id) selected @endif value="{{ $subcategory->id }}">{{ $subcategory->name }}</option>
                    @endforeach
                </select>
                ...
                <select id="subject" name="subject">
                    ...
                    @foreach($subjects as $subject)
                        <option @if($paper->subject_id == $subject->id) selected @endif value="{{ $subject->id }}">{{ $subject->name }}</option>
                    @endforeach
                </select>
                    ...
                    <select class="form-control" name="chapter_id" id="chapter_id">
                           <option value="">--Select--</option>
                            @foreach($subjects as $chapter)
                                <option @if($paper->chapter_id == $chapter->id) selected @endif value="{{ $chapter->id }}">{{ $chapter->name }}</option>
                            @endforeach
                ...
                <select id="topic" name="topic">
                    ...
                    @foreach($topics as $topic)
                        <option @if($paper->topic_id == $topic->id) selected @endif value="{{ $topic->id }}">{{ $topic->name }}</option>
                    @endforeach
        ...
        <div class="center-card" style="width:100%; height:auto;">
            ...
            <div class="form-row" >
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Test Name" name="name" id="name" value="{{$paper->name ?? ''}}">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Test Duration" name="duration" id="duration"  value="{{$paper->duration ?? 0}}">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" placeholder="Enter in no." name="total_questions" id="total_questions"  value="{{$paper->total_questions ?? ''}}" readonly>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" placeholder="Enter in no." name="total_marks" id="total_marks" value="{{$paper->total_marks ?? 0}}" readonly>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <input type="checkbox" id="question-type-mcq" name="question_type[]" value="MCQ" @if($paper->mcq_total_question > 0) checked @endif>
                    <label for="question-type-mcq"> MCQ</label>
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="mcq_total_question" name="mcq_total_question" value="{{$paper->mcq_total_question ?? 0}}" placeholder="Total Question MCQ" readonly>
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="mcq_mark_per_question" name="mcq_mark_per_question" value="{{$paper->mcq_mark_per_question ?? 0}}" placeholder="Each Question Marks MCQ" readonly>
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="mcq_total_marks" name="mcq_total_marks" value="{{$paper->mcq_total_marks ?? 0}}" placeholder="Total Marks MCQ" readonly>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <input type="checkbox" id="question-type-story" name="question_type[]" value="Story Based" @if($paper->story_total_question > 0) checked @endif>
                    <label for="question-type-story"> Story Based</label><br>
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="story_total_question" name="story_total_question" value="{{$paper->story_total_question ?? 0}}" placeholder="Total Question Story" readonly>
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="story_mark_per_question" name="story_mark_per_question" value="{{$paper->story_mark_per_question ?? 0}}" placeholder="Each Question Marks Story" readonly>
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="story_total_marks" name="story_total_marks" value="{{$paper->story_total_marks ?? 0}}" placeholder="Total Marks Story" readonly>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <input type="checkbox" id="question-type-subjective" name="question_type[]" value="Subjective" @if($paper->subjective_total_question > 0) checked @endif >
                        <label for="question-type-subjective"> Subjective</label><br>
                    
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="subjective_total_question" name="subjective_total_question" value="{{$paper->subjective_total_question ?? 0}}" placeholder="Total Question Subjective" readonly>
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="subjective_mark_per_question" name="subjective_mark_per_question" value="{{$paper->subjective_mark_per_question ?? 0}}" placeholder="Each Question Marks Subjective" readonly>
                </div>
                <div class="form-group col-md-2">
                    <input type="number" id="subjective_total_marks" name="subjective_total_marks" value="{{$paper->subjective_total_marks ?? 0}}" placeholder="Total Marks Subjective" readonly>
                </div>
            </div>
            <div class="form-row">
                <!--div class="form-group col-md-4">
                ...
                <!--div class="form-group col-md-6">
                    ...
                    <select id="question_generated_by" name="question_generated_by" class="form-control">
                        ...
                        <option value="manual" @if($paper->question_generated_by == "manual") selected @endif>Manual</option>
                        <option value="random" @if($paper->question_generated_by == "random") selected @endif>Random</option>
                    </select>
                </div-->
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    <label for="text">Test Instructions (If Any)</label>
                        <textarea style="height:150px" id="test_instruction" name="test_instruction" class="form-control" id="exampleFormControlTextarea1" rows="4">{!! $paper->test_instruction !!}</textarea>
        ...
        <div class="tab-pane-generated">
            <div class="tab-content px-1 pt-1">
                <div class="tab-pane mcq-tab active" id="mcq-tab" role="tabpanel" aria-labelledby="base-mcq">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="box-area-questions">
                                    <h4>Your Questions(MCQ) <span id="questioncountmcqshow">{{count($mcqArr)}}/{{$paper->mcq_total_question ?? 0}}</span></h4>
                                    <div class="box-questns">
                                        <ul class="selected-questions customquestionselectedbox-mcq" id="customquestionselectedbox-mcq">
                 ...
                 <div class="tab-pane story-tab active" id="story-tab" role="tabpanel" aria-labelledby="base-story">
                    <div class="customquestiondiv">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="box-area-questions">
                                    <h4>Your Questions(Story Based) <span id="questioncountstoryshow">{{count($passageArr)}}/{{$paper->story_total_question ?? 0}}</span></h4>
                                    <div class="box-questns">
                                        <ul class="selected-questions customquestionselectedbox-story" id="customquestionselectedbox-story">
                            ...
                            <div class="col-sm-2">
                                ...
                                <div class="button-actns-questn">
                                    <button class="btn btn-primary addquestiontoselected-story" type="button" fdprocessedid="49r4zxe"><i class="fa fa-arrow-left"></i></button>
                                    <i class="fa fa-exchange"></i>
                                    <button class="btn btn-danger removequestionfromselected-story" type="button" fdprocessedid="2x8rl7"><i class="fa fa-arrow-right"></i></button>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="box-area-questions">
                ...
                <div class="tab-pane subjective-tab active" id="subjective-tab" role="tabpanel" aria-labelledby="base-subjective"> 
                    <div class="customquestiondiv">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="box-area-questions">
                                    <h4>Your Questions(Subjective) <span id="questioncountsubjectiveshow">{{count($subjectiveArr)}}/{{$paper->subjective_total_question ?? 0}}</span></h4>
                                    <div class="box-questns">
                                        <ul class="selected-questions customquestionselectedbox-subjective" id="customquestionselectedbox-subjective">
                            ...
                            <div class="col-sm-2">
                                ...
                                <div class="button-actns-questn">
                                    <button class="btn btn-primary addquestiontoselected-subjective" type="button" fdprocessedid="49r4zxe"><i class="fa fa-arrow-left"></i></button>
                                    <i class="fa fa-exchange"></i>
                                    <button class="btn btn-danger removequestionfromselected-subjective" type="button" fdprocessedid="2x8rl7"><i class="fa fa-arrow-right"></i></button>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="box-area-questions">
                                    <h4>All Questions <span id="questioncountshow"></span></h4>
                                    <div class="box-questns">
                                        <ul class="customquestionbox-subjective" id="customquestionbox-subjective">
...
<button type="button" class="btn btn-primary" id="preview-test-btn" filter_type="competitive"><i class="fa fa-check"></i> Add Test</button>
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id='preview-modal'>
</div>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#preview-test-btn', function(event) {
           ...
           // alert(selectedqu);
            ...
            formData.append('test_instruction', $('#test_instruction').val());
