        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        <h5 class="card-title mb-0">Study Material Orders</h5>
                        <h6 class="card-subtitle text-muted">
                            Manage Study Material Orders here.
                        </h6>
                    </div>
                ...
                {{-- SEARCH --}}
                <div class="mb-3">
                    <form method="GET" action="{{ route('order.study-material-orders') }}"
                        ...
                        <a href="{{ route('order.study-material-orders') }}" class="btn btn-outline-secondary btn-sm">
                            Clear
                        </a>
                    </form>
                </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="10" class="text-center text-muted">
                                        No study material orders found.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
