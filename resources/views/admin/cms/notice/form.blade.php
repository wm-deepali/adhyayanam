...
<div class="mb-3">
    ...
    <select name="type"
        ...
        <option value="pdf" {{ ($notice->type ?? '') == 'pdf' ? 'selected' : '' }}>PDF</option>
        <option value="link" {{ ($notice->type ?? '') == 'link' ? 'selected' : '' }}>Link</option>
        <option value="page" {{ ($notice->type ?? '') == 'page' ? 'selected' : '' }}>Page</option>
    </select>
</div>
...
<div id="pageFields" class="d-none">
    ...
    <div class="mb-3">
        ...
        <textarea name="short_description"
                  class="form-control"
                  rows="2">{{ $notice->short_description ?? '' }}</textarea>
    </div>
    ...
    <div class="mb-3">
        ...
        <textarea id="detailEditor"
                  name="detail_content"
                  class="form-control">{!! $notice->detail_content ?? '' !!}</textarea>
    </div>
