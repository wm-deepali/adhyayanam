            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('cm.exam.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Name" value="{{$exam->name ?? ''}}"
                            required>
                        @if ($errors->has('name'))
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="description"
                            placeholder="Description">{{$exam->description ?? ''}}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="meta_title" value="{{$exam->meta_title ?? ''}}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="meta_keyword" value="{{$exam->meta_keyword ?? ''}}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="meta_description"
                            placeholder="Meta Description">{{$exam->meta_description ?? ""}}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" name="canonical_url" value="{{$exam->canonical_url ?? ""}}"
