    ...
    <div class="bg-light rounded">
        <div class="card">
            <div class="card-body">
                ...
                <form id="daily-form" method="POST" action="{{ route('daily.boost.update', $dailyBooster->id) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="title" value="{{ $dailyBooster->title }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="start_date" value="{{ $dailyBooster->start_date }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="youtube_url" value="{{ $dailyBooster->youtube_url }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="short_description" placeholder="Short Description"
                            required>{{ $dailyBooster->short_description }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="editor" name="detail_content"
                            style="height: 300px;">{!! $dailyBooster->detail_content !!}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="image_alt_tag"
                            value="{{ $dailyBooster->image_alt_tag }}" placeholder="Image Alt Tag">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="meta_title" value="{{ $dailyBooster->meta_title }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="meta_keyword"
                            value="{{ $dailyBooster->meta_keyword }}" placeholder="Meta Keyword">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="meta_description"
                            value="{{ $dailyBooster->meta_description }}" placeholder="Meta Description">
