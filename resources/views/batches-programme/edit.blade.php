    ...
    <div class="bg-light rounded">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('batches-programme.update', $batch->id) }}" id="batch-form"
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="batch_heading"
                                value="{{ old('batch_heading', $batch->batch_heading) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="duration"
                                    value="{{ old('duration', $batch->duration) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="short_description"
                            value="{{ old('short_description', $batch->short_description) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        @if($batch->thumbnail_image)
                            <img src="{{ asset('storage/' . $batch->thumbnail_image) }}"
                                style="height: 50px; width: auto; margin-top:5px;" alt="">
                        @endif
                    </div>
    ...
    @error('detail_content')<span class="text-danger">{{ $message }}</span>@enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="youtube_url"
                            value="{{ old('youtube_url', $batch->youtube_url) }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="meta_keyword"
                                    value="{{ old('meta_keyword', $batch->meta_keyword) }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="image_alt_tag"
                                    value="{{ old('image_alt_tag', $batch->image_alt_tag) }}">
                            </div>
                        </div>
                    </div>
