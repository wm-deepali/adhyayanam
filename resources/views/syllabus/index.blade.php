            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="#" id="exportSyllabusBtn" class="btn btn-outline-dark">
...
@push('after-scripts')
    ...
    <script>
        ...
        $('#exportSyllabusBtn').on('click', function (e) {

            e.preventDefault();

            let table = $('#syllabusTable').DataTable();

            let search = table.search();

            let url = "{{ route('syllabus.export') }}";
