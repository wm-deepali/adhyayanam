...
<body class="hidden-bar-wrapper">
    ...
    <div class="auto-container">
        ...
        <div class="content">
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-4">
              <div class="cm-all"><a href="{{route('subject-pyqs',$subject->id)}}">{{$subject->name}} PYQ </a></div>
            </div>
            @endforeach
			@endif
      ...
      <div class="smaterial-box">
        <div class="content">
          <h4 class="osd sm">Papers For {{$subcat->name}}</h4>
          <div class="row">
		  @if(isset($papers) && count($papers) >0)
			@foreach($papers as $paper)
            <div class="col-sm-12 col-md-6">
                
              <div class="cm-all a"><a href="{{url('../storage/app/pyq-pdf',$paper->pdf)}}"  target="_blank">{{$paper->pdf}}</a></div>
            </div>
            @endforeach
			@endif
