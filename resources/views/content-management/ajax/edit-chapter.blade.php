...
<div class="bg-light rounded">
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('cm.chapter.update', $chapter->id) }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
                    ...
                    <select class="form-select" name="exam_com_id" id="exam_com_id" required>
                        ...
                        @foreach($commissions as $commission)
                            <option @if($chapter->exam_com_id == $commission->id) selected @endif value="{{ $commission->id }}">{{ $commission->name }}</option>
                        @endforeach
                    </select>
                    @error('exam_com_id')
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="category_id" id="category_id" required>
                        ...
                        <option @if($chapter->category_id == $category->id) selected @endif value="{{ $category->id }}">{{ $category->name }}</option>
                    @endforeach
                    </select>
                    @error('category_id')
                        <span class="text-danger">{{ $message }}</span>
                ...
                <div class="mb-3 sub-cat hidecls">
                    ...
                    <select class="form-select" name="sub_category_id" id="sub_category_id" >
                        ...
                        <option @if($chapter->sub_category_id == $subcategory->id) selected @endif value="{{ $subcategory->id }}">{{ $subcategory->name }}</option>
                    @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="subject_id" required id="subject_id">
                        ...
                        @foreach($subjects as $subject)
                            <option @if($chapter->subject_id == $subject->id) selected @endif value="{{ $subject->id }}">{{ $subject->name }}</option>
                        @endforeach
                    </select>
                    @error('subject_id')
                        <span class="text-danger">{{ $message }}</span>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name" value="{{$chapter->name}}"  placeholder="Name" required>
                    @if ($errors->has('name'))
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="chapter_number" value="{{$chapter->chapter_number}}" placeholder="Chapter Number">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="description" value="{{$chapter->description}}" placeholder="Description" required>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" name="status">
                        <option @if($chapter->status == 1) selected @endif value="1">Active</option>
                        <option @if($chapter->status == 0) selected @endif  value="0">Inactive</option>
                    </select>
