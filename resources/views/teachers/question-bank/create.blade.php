...
@section('content')
    <div class="bg-light rounded">
        <div class="card">
            <div class="card-body">
                ...
                <form id="form-question" action="{{ route('teacher.question.bank.store') }}" method="POST"
                        ...
                        <div class="question-block">
                            <div class="row">
                                ...
                                <div class="col-md-6" id="story_question_form" style="display:none;">
                                    ...
                                    <div class="mb-3" id="multiple_choice_passage_div" style="display: none;">
                                                ...
                                                <div class="col-md-12 solution-group" style="display: none;">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea class="form-control ckeditor"
                                                            name="passage_mcq_solution[]"
                                                            id="multiple_choice_passage_solution" rows="2" cols="4"
                                        ...
                                        <div class="optionBox_rp">
                                            <div class="blockbox block_rp">
                                                ...
                                                <div class="col-md-12 solution-group" style="display: none;">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea class="form-control ckeditor"
                                                            name="reasoning_passage_solution[]"
                                                            id="reasoning_subjective_passage_solution" rows="2" cols="4"
                                                            placeholder="Solution"></textarea>
                                                    </div>
                                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // initialize editors on initial render
            if (typeof initEditorsIn === 'function') { initEditorsIn(document); }
            // Trigger toggle based on selected value on page load
            if (select) {
                var event = new Event('change'); // create event programmatically
