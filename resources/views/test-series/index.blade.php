            ...
            <div class="card-body">
                ...
                <div class="table-responsive-lg">
                    ...
                    <table class="table table-striped mt-5" style="width:100%">
                        ...
                        <tbody id="testSeriesTableBody">
                            @include('test-series.table-rows', ["test_series" => $test_series])
                        </tbody>
                    </table>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.filterbtn').on('click', function () {
                ...
                $.ajax({
                    url: "{{ route('test.series.filter') }}",
                    type: "GET",
                    data: data,
                    beforeSend: function () {
                        $('#testSeriesTableBody').html(`<tr><td colspan="9" class="text-center">Loading...</td></tr>`);
                    },
                    success: function (response) {
                        $('#testSeriesTableBody').html(response.html);
                    },
                    error: function () {
                        $('#testSeriesTableBody').html(`<tr><td colspan="9" class="text-center text-danger">Error loading data</td></tr>`);
                    }
                });
            });
