        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="container mt-4">
                    <form id="privacy-form" method="POST" action="{{ route('privacy.policies.store') }}"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="heading1" class="form-label">Heading</label>
                            <input value="{{ $privacy->heading1 ?? ""}}" type="text" class="form-control" name="heading1"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="editor" name="description1"
                                style="height: 300px;">{!!$privacy->description1!!}</textarea>
