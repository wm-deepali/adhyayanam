			...
			<div class="main-slider-carousel owl-carousel owl-theme">
				...
				@foreach($banners->sortBy('position') as $data)
					<div class="slide" style="padding: 0px;">
						<div class="f">
							<a href="{{ isset($data->link) ? $data->link : '#' }}" target="_blank"><img
									src="{{ asset('storage/' . $data->image) }}" /></a>
						</div>
					</div>
				@endforeach
					...
					<div class="filter-box">
						<div class="d-flex justify-content-between align-items-center flex-wrap">
							...
							<div class="left-box d-flex align-items-center">
								<div class="results date-filter"><input type="date" name="search" placeholder="Filter Date"
										required="">
								</div>
							</div>
							<!-- Right Box -->
										...
										<ul>
											@if($topic->currentAffair)
												@foreach($topic->currentAffair as $affair)
													<li>
														<a
															href="{{route('current.details', $affair->id)}}">{{$affair->title . ': ' . $affair->short_description}}</a>
													</li>
												@endforeach
											@endif
										</ul>
					...
					<div class="row clearfix">
						...
						<div class="feature-block col-lg-4 col-md-6 col-sm-12">
							<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
								<div class="icon"><img style="max-width:70px;" src="{{ asset('storage/' . $feature->icon1) }}"
										alt=""></div>
						...
						<div class="feature-block col-lg-4 col-md-6 col-sm-12">
							<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
								<div class="icon"><img style="max-width:70px;" src="{{ asset('storage/' . $feature->icon2) }}"
										alt=""></div>
						...
						<div class="feature-block col-lg-4 col-md-6 col-sm-12">
							<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
								<div class="icon"><img style="max-width:70px;" src="{{ asset('storage/' . $feature->icon3) }}"
										alt=""></div>
								...
								<div class="lower-content">
									...
									<div class="lower-box osd m">
										<div class="d-flex justify-content-between align-items-center">
											...
											<div class="cmm">
												<a class="course-btn osd" href="{{route('courses.detail', $course->id)}}">View
										...
										<div class="course-block-two style-two col-xl-3 col-lg-6 col-md-6 col-sm-12">
											<div class="inner-box">
												<div class="image osd-f">
													<a href="test-series-detail.html"><img src="{{url('storage/' . $data->logo)}}"
															alt=""></a>
												...
												<div class="lower-content osdc">
													<div class="content">
														...
														<div class="number-of-test">
															...
															Test <span class="green-free">| {{$data->free_tests}} Free</span>
														</div>
														<div class="contents">
															<ul class="lstyle">
													...
													<div class="bottom-btn">
														<a class="course-btn osd" href="test-series-detail.html">View Test
															Series</a>
													</div>
												</div>
											</div>
						...
						<div class="row">
							@foreach($studyCategories as $category)
								<div class="course-block-two col-xl-3 col-lg-4 col-md-4 col-sm-6">
									<div class="inner-box">
										<div class="image">
											<a href="{{route('study.material.front')}}"><img
													src="{{ url('storage/' . $category->image)}}" alt="{{$category->alt_tag ?? ''}}"
													style="height:254px;"></a>
										</div>
							...
							<div class="col-12">
								<div class="button-box">
									<a href="{{route('study.material.front')}}" class="theme-btn btn-style-three"><span
				...
				<div class="row clearfix video">
					...
					<div class="col-12">
						...
						<div class="bottom-box text-center">
							<div class="button-box">
								<a href="{{route('daily.boost.front')}}" class="theme-btn btn-style-three"><span
										class="txt">View All Videos</span></a>
							</div>
						</div>
					</div>
					...
					@foreach($upcomingExams as $data)
						{{--<div class="table-osd mb-5">
							<table class="osd-table" style="border-collapse: collapse; width: 100%;">
								<tbody>
									<tr>
										<td style="text-align: center; width: 99.7282%;" class="f22" colspan="6">
											<strong>Government
												Exams Upcoming:
									...
									<tr>
										...
										<td style="text-align: center;"><a href="{{asset('storage/'.$data->pdf)}}"
												target="_blank" rel="noopener" download="{{$data->examination_name}}"><img
						...
						<div class="course-block col-lg-6 col-md-6 col-sm-12">
							<div class="inner-box osdb">
								<h4><a href="{{asset('public/' . $data->pdf)}}" target="_blank" rel="noopener"
										download="{{$data->examination_name}}">{{$data->examination_name}}; Download PDF</a>
								</h4>
								<div class="courses">{{$data->examination_name ?? ""}} has been declared on
									{{$data->advertisement_date ?? ""}} by {{$data->exam_commission->name ?? ""}}. Last Date of
									Submission {{$data->submission_last_date ?? ""}}</div>
							</div>
						</div>
					@endforeach
					<div class="col-12">
						...
						<div class="bottom-box text-center">
							<div class="button-box">
								<a href="{{route('upcoming.exam.front')}}" class="theme-btn btn-style-three"><span
										class="txt">View All Upcoming Exams</span></a>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="inner-box">
								...
								<div class="author-box">
									<div class="box-inner">
										...
										<span class="quote-icon p-5"><img src="{{url('images/icons/quote-icon.png')}}"
												alt="" /></span>
									</div>
								</div>
							</div>
					...
					<div class="row clearfix">
						...
						<div class="image-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column">
								<div class="pattern-one" style="background-image: url(images/background/pattern-1.png)">
								</div>
						...
						<div class="content-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-columns">
								...
								<div class="icon-box-test">
									<div class="i-bx1">
										<div class="inner-a">
											<div class="icon"><img src="{{asset('storage/' . $programmeFeautre->icon1)}}"
													alt="" style="max-width:40px;" /></div>
										</div>
										<div class="inner-b">{{$programmeFeautre->icon_title1}}</div>
									</div>
									<div class="i-bx1">
										<div class="inner-a">
											<div class="icon"><img src="{{asset('storage/' . $programmeFeautre->icon2)}}"
													alt="" style="max-width:40px;" /></div>
										</div>
								...
								<div class="icon-box-test b">
									<div class="i-bx1">
										<div class="inner-a">
											<div class="icon"><img src="{{asset('storage/' . $programmeFeautre->icon3)}}"
													alt="" style="max-width:40px;" /></div>
										</div>
									...
									<div class="i-bx1">
										<div class="inner-a">
											<div class="icon"><img src="{{asset('storage/' . $programmeFeautre->icon4)}}"
													alt="" style="max-width:40px;" /></div>
										</div>
								...
								<div class="news-block">
									<div class="inner-box wow fadeInLeft animated" data-wow-delay="0ms"
										...
										<div class="lower-content">
											...
											<div class="text">
												{{ Illuminate\Support\Str::limit($blog->short_description, 70) }}...</div>
