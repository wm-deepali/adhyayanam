		  ...
		  <div class="modal-body p-30 bg-white">
            ...
            <div>
                <div class="d-flex flex-row">
                    <div class=""><img src="{{ url('src/images/avatar/avatar-13.png')}}" alt="user" class="rounded bg-danger-light w-150" width="100"></div>
                    <div class="ps-20">
              ...
              <div>
                ...
                <div class="d-flex align-items-center mb-30">
                    ...
                    <div class="d-flex flex-column fw-500">
                        <a href="https://netiias.com/design/test-series.html" class="text-dark hover-info mb-1 fs-16">Test Series</a>
