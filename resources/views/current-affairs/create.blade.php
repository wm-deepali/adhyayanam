...
<div class="bg-light rounded p-2">
    <div class="card">
        <div class="card-body">
            ...
            <form id="affair-form" method="POST" action="{{ route('current.affairs.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input id="publishing_date" type="date" class="form-control" name="publishing_date" placeholder="Y-m-d" required>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const form = document.getElementById('affair-form');
