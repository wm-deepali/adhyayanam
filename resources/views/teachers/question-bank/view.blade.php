        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-2">
                    <div class="row">
                        <div class="col-md-4">
                            <p><strong>Language</strong>: {{ ($question->language ?? null) == '1' ? 'Hindi' : 'English' }}</p>
                        </div>
                        <div class="col-md-4">
                            <p><strong>Question Category</strong>: {{ $catArr[$question->question_category ?? ''] ?? 'N/A' }}</p>
                        </div>
                        @if(($question->question_category ?? null) == 1)
                            <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <p><strong>Has Instructions</strong>: {{ ($question->has_instruction ?? null) == 1 ? 'Yes' : 'No' }}</p>
                        </div>
                        @if(($question->has_instruction ?? null) == 1)
                            <div class="col-md-4">
                        ...
                        @if(($question->question_type ?? null) == 'MCQ')
                            <div class="col-md-12">
                        ...
                        @if(($question->question_type ?? null) == 'Subjective')
                        ...
                        @if(($question->question_type ?? null) == 'Story Based')
                        ...
                        @if(($question->has_solution ?? null) == 'yes' && strip_tags($question->solution ?? "") != "")
                            <div class="col-md-12">
