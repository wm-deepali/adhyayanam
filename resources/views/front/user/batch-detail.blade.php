...
@section('header')
    <title>{{$batch->meta_title ?? 'Batch Details'}}</title>
    <meta name="description" content="{{ $batch->meta_description ?? 'Default Description' }}">
    <meta name="keywords" content="{{ $batch->meta_keyword ?? 'default, keywords' }}">
...
@section('content')
    ...
    <body class="hidden-bar-wrapper">
        ...
        <section class="course-page-title" style="background-image: url(images/background/pattern-10.png)">
            <div class="auto-container">
                ...
                <div class="text">{{$batch->short_description}}</div>
            </div>
        </section>
            ...
            <div class="auto-container">
                ...
                <div class="upper-box py-4">
                    <div class="row g-3 g-lg-4">
                        ...
                        <div class="course-info col-6 col-lg-4">
                            <div class="inner-box h-100">
                                <span class="icon flaticon-hourglass"></span>
                                Duration
                                <strong>{{ $batch->duration }} Weeks</strong>
                            </div>
                        </div>
                        ...
                        <div class="course-info col-6 col-lg-4">
                            <div class="inner-box h-100">
                                ...
                                Batch Fee
                                <strong>₹{{ $batch->offered_price }}</strong>
                            </div>
                        </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="content-column col-lg-8 col-md-12 col-sm-12">
                            <div class="inner-column">
                                <div class="image">
                                    @if($batch->youtube_url)
                                        @php
                                            preg_match("/youtu\.be\/([^\?\/]+)/", $batch->youtube_url, $matches);
                                        ...
                                        @else
                                            <img src="{{ asset('storage/' . $batch->banner_image) }}"
                                                alt="{{ $batch->image_alt_tag ?? $batch->batch_heading }}" loading="lazy" />
                                ...
                                <div class="news-detail">
                                    <div class="post-share-options x">
                                        <div
                                            ...
                                            <div class="tags-box">Share This Batch :</div>
                                            <ul class="social-box">
                                                <li>
                                                ...
                                                <li>
                                                    <a class="fa fa-twitter" target="_blank"
                                                        href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ urlencode($batch->batch_heading) }}">
                                                    </a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a class="fa fa-pinterest-p" target="_blank"
                                                        href="https://pinterest.com/pin/create/button/?url={{ urlencode(url()->current()) }}&media={{ url('storage/' . $batch->banner_image) }}&description={{ urlencode($batch->course_heading) }}">
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
    ...
    <li>
        <span class="icon flaticon-price-tag"></span>
        Discount
        <strong>₹{{ number_format($batch->discount, 2) }}</strong>
    </li>
@endif

                                    </ul>

                                    <a href="{{ route('contact.inquiry') }}" class="enroll-now theme-btn">
                                        Enquire Now
                                    </a>
                        ...
                        <div class="mobile-fixed-price-bar d-lg-none">
                            <div class="price-section">
                                <span class="price-label">Batch Fee</span>
                                <div class="price-value">
                                    ₹{{$batch->offered_price}}
                                    <del>₹{{$batch->course_fee}}</del>
                                </div>
                            </div>
                    ...
                    <div class="course-info-tabs">
                        <div class="course-tabs tabs-box">
                            ...
                            <ul class="tab-btns tab-buttons clearfix cvx">
                                <li data-tab="#course-overview" class="tab-btn active-btn">
                                    Overview
                                </li>

                                <li data-tab="#course-curriculum" class="tab-btn">
                                    Details
                                </li>
                            </ul>
