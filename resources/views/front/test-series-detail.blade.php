          ...
          <div class="col-12 col-sm-12 col-md-8">
            <div class="test-s-l">
              ...
              <div class="test-fst">
                ...
                <div class="fe-b"><span class="bg-g">@if($testseries->fee_type == 'paid') Premium @else Free @endif
                    Tests</span></div>
                      ...
                      <div class="content">
                        @foreach($testseries->tests->where('paper_type', '!=', 1) as $testpaper)
                          ...
                          <div class="m-up-cont">
                            ...
                            {{-- ✅ TEST-WISE SYLLABUS --}}
                            <div class="test-syllabus mt-2">
                              @if($testpaper->subject)
                                <div><strong>Subject:</strong> {{ $testpaper->subject->name }}</div>
                              @endif

                              @if($testpaper->chapter)
                                <div><strong>Chapter:</strong> {{ $testpaper->chapter->name }}</div>
                              @endif

                              @if($testpaper->topic)
                                <div><strong>Topic:</strong> {{ $testpaper->topic->name }}</div>
                              @endif
                            </div>
                          ...
                          <div class="m-up-cont">
                            <div class="f-lex-grid">
                              <div class="t-name-mockup">
                                ...
                                <div class="n-mcname">
                                  {{ $testpaper->name }}
                                  <span class="no-of-user-mt">39.3k Users</span>
                                </div>
                              </div>

                              @if($testpaper->test_type === "free")
                                <div class="mockup-start-btn">
                                  <a href="#" class="osd-cus s">Attempt Now</a>
                                </div>
                              @else
                                <div class="mockup-start-btn">
                                  <a href="#" class="osd-cus s un">
                                    <span class="fa fa-lock osds"></span>
                                    Unlock test
                                  </a>
                                </div>
                              @endif
                            ...
                            <div class="bottom-section-mcts">
                              ...
                              <div class="tq">
                                <span class="icon flaticon-file osds"></span>
                                {{ $testpaper->total_marks }} Marks
                              </div>
                              <div class="tq">
                                <span class="icon flaticon-time osds"></span>
                                {{ $testpaper->duration }} Minutes
                              </div>
                            </div>
                          </div>
                ...
                <div class="sidew-conts">
                  @foreach($relatedtestseries as $testseriesr)
                    <div class="sidew-cont">
                      ...
                      <div class="rights-d"
                        onclick="window.location.href='{{ route('test-series-detail', $testseriesr->slug) }}'">
