                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $data->id }}">
                                    <li><a class="dropdown-item text-primary"href="{{route('teacher.question.bank.view', $data->id)}}">View</a></li>
                                    <li><a class="dropdown-item text-secondary"
                                            href="{{ route('teacher.question.bank.edit', $data->id) }}">Edit</a></li>
                                    <li>
                                        <button type="button" class="dropdown-item text-danger deleteBtn"
                                            data-id="{{ $data->id }}" data-url="{{ route('teacher.question.bank.delete', $data->id) }}">
                                            Delete
                                        </button>
                                    </li>
                                </ul>
