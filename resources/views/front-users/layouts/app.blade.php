...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed">
    @if(auth()->user() != '' && auth()->user()->email == '')
        <div id="over"
            style="position: absolute;top:0;left:0;width: 100%;height:100%;z-index:999;opacity:0.4;filter: alpha(opacity = 50);background-color:#eee;">
        </div>
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="logo modals"><a href="{{url('/')}}"><img src="{{url('images/Neti-logo.png')}}" alt=""
                                    title=""></a></div>
                        <div class="get-start">
                        ...
                        <div class="form-login-reg comment-form modal-l">
                            <form id="registerForm">
                                <div class="inner-frm contact-form">
                                    ...
                                    <div class="form-group">
                                        <label for="confirm_password" class="col-sm-2 control-label">Confirm Password*
                                        </label>
