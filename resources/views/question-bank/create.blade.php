...
<div class="bg-light rounded">
    <div class="card">
        <div class="card-body">
            ...
            <form id="form-question" action="{{ route('question.bank.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-check mt-2">
                                    <input id="has_instruction" type="checkbox" class="form-check-input has-instruction" name="has_instruction" onchange="toggleInstruction(this)">
                                ...
                                <div class="form-group mt-2">
                                    <input type="checkbox" class="form-check-input has-option-e" name="has_option_e" onchange="toggleOptionE(this)">
