...
<div class="modal modal-right fade" id="quick_user_toggle" tabindex="-1">
    ...
    : url('src/images/avatar/avatar-13.png') }}" alt="user" class="rounded bg-danger-light w-150" width="100">
                        </div>
                        ...
                        <div class="ps-20">
                            ...
                            <!-- Edit Profile Link -->
                            <div class="mt-10">
                                <a href="{{ route('user.profile') }}" class="btn btn-sm btn-primary-light">
                                    <i data-feather="edit-2" style="width:14px;height:14px;" class="me-5"></i>Edit
                                    Profile
                                </a>
                            </div>
                        ...
                        <ul class="sidebar-menu" data-widget="tree">
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="{{route('user.test-series')}}"><i class="icon-Commit"></i>Test
                                            Series</a></li>
                                    <li><a href="{{ route('user.my-pyq-papers') }}"><i class="icon-Commit"></i>My PYQ
                                            Papers</a></li>
                                    <li><a href="{{route('user.test-papers')}}"><i class="icon-Commit"></i>Test
                                            Results</a></li>
                                </ul>
                            </li>
