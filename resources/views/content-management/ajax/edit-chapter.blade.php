...
@section('content')
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('cm.chapter.update', $chapter->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="exam_com_id" id="exam_com_id" required>
                            ...
                            @foreach($commissions as $commission)
                                <option @if($chapter->exam_com_id == $commission->id) selected @endif
                    ...
                    <div class="mb-3 sub-cat hidecls">
                        ...
                        <select class="form-select" name="sub_category_id" id="sub_category_id">
                            @foreach($subcategories as $subcategory)
                                <option @if($chapter->sub_category_id == $subcategory->id) selected @endif
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" value="{{$chapter->name}}" placeholder="Name"
                            required>
                        @if ($errors->has('name'))
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="chapter_number" value="{{$chapter->chapter_number}}"
    ...
    <script>
        $(document).ready(function () {
            ...
            // --- SHOW SUBCATEGORY IF ALREADY SELECTED (edit mode) ---
            let existingSubCategory = "{{ $chapter->sub_category_id }}";
            if (existingSubCategory && existingSubCategory !== "") {
