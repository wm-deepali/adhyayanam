        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <small class="text-muted">Edit live class or video learning content here.</small>
                </div>
                    ...
                    <div class="row mx-1">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <select class="form-control" name="course" id="course">
                                ...
                                @foreach($courses as $course)
                                    <option value="{{ $course->id }}" {{ ($video->course_id ?? '') == $course->id ? 'selected' : '' }}>{{ $course->name }}
                                    </option>
                                @endforeach
                            </select>
                                ...
                                <div class="video-block border p-3 mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input type="file" class="form-control-file" id="video_cover_image"
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input type="file" class="form-control" name="video_assignment_file"
                                                accept=".pdf,.doc,.docx">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input type="file" class="form-control" name="video_solution_file"
                                                accept=".pdf,.doc,.docx">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <label>Content</label>
                                            <textarea class="form-control" id="video_content" name="video_content"
                        ...
                        <div class="live-container"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    <label>Upload Assignment File</label>
                                    <input type="file" class="form-control" name="live_assignment_file"
                                        accept=".pdf,.doc,.docx">
                                    @if(!empty($video->assignment_file))
                                        <small class="d-block mt-1">
                                            <a href="{{ asset('storage/' . $video->assignment_file) }}" target="_blank">
                                ...
                                <div class="col-md-6 mb-2">
                                    <label>Upload Solution File</label>
                                    <input type="file" class="form-control" name="live_solution_file"
                                        accept=".pdf,.doc,.docx">
                                    @if(!empty($video->solution_file))
                                        <small class="d-block mt-1">
                                            <a href="{{ asset('storage/' . $video->solution_file) }}" target="_blank">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="url" class="form-control" name="live_link" value="{{ $video->live_link }}"
                                ...
                                <div class="col-md-12 mb-2">
                                    <label>Content</label>
                                    <textarea class="form-control" id="live_content" name="live_content"
                                        rows="3">{{ old('content', $video->content ?? '') }}</textarea>
                                    <div class="text-danger validation-err" id="content-err"></div>
                                </div>
                            </div>
            ...
            function filterTeachers() {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            const selectedTeacher = '{{ $video->teacher_id ?? "" }}';

                            $('#teacher').html(response.html);

                            // If saved teacher exists, select it
                            if (selectedTeacher && $('#teacher option[value="' + selectedTeacher + '"]').length) {
                                $('#teacher').val(selectedTeacher);
                            }
                            // else: default "Select Teacher" stays selected automatically
                        }
                    },
                    error: function (xhr) {
