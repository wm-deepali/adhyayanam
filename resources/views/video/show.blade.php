            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center border-bottom pb-2 mb-3">
                    ...
                    <div>
                        ...
                        @if(\App\Helpers\Helper::canAccess('manage_videos_edit'))
                    ...
                    @if($video->type == 'video')
                        ...
                        @if($video->video_type == 'Storage')
                            <div class="col-md-6 mb-3">
                                ...
                                @if($video->video_file)
                                    <a href="{{ asset('storage/' . $video->video_file) }}" target="_blank"
                    ...
                    <div class="row text-center">
                        <div class="col-md-4 mb-3">
                            <div class="border rounded p-3 bg-white shadow-sm h-100">
                                ...
                                @if($video->image)
                                    <img src="{{ asset('storage/' . $video->image) }}" class="img-fluid mt-2 rounded"
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="border rounded p-3 bg-white shadow-sm h-100">
                                ...
                                @if($video->cover_image)
                                    <img src="{{ asset('storage/' . $video->cover_image) }}" class="img-fluid mt-2 rounded"
                                        style="max-height: 160px; object-fit: contain;">
                                @else
                                    <p class="mt-3 text-muted">--</p>
                                @endif
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="border rounded p-3 bg-white shadow-sm h-100">
                                ...
                                @if($video->assignment)
                                    <img src="{{ asset('storage/' . $video->assignment) }}" class="img-fluid mt-2 rounded"
                                        style="max-height: 160px; object-fit: contain;">
                                @else
                                    <p class="mt-3 text-muted">--</p>
                                @endif
                ...
                @if(\App\Helpers\Helper::canAccess('manage_videos_delete'))
