        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        <h5 class="mb-0">Courses Summary</h5>
                        <small class="text-muted">Manage Courses Summary here</small>
                    </div>
                ...
                {{-- SEARCH + CLEAR --}}
                <form method="GET" action="{{ route('students.student-course-summary') }}" class="d-flex gap-2 mb-3">
                    ...
                    @if(request()->filled('search'))
                        <a href="{{ route('students.student-course-summary') }}" class="btn btn-secondary">
                            Clear
                        </a>
                    @endif
                </form>
