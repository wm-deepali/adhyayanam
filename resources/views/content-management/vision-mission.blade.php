            ...
            <form method="POST" action="{{ route('vision.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea 
                        class="form-control" 
                        name="description1" 
                        placeholder="Description 1" required>{{ $vision->description1 ?? "" }}</textarea>
                ...
                @if (isset($vision->image1))
                    <div class="mb-3">
                        ...
                        <br>
                        <img src="{{ asset('storage/' . $vision->image1) }}" alt="Uploaded Image" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                    </div>
                @endif
            
                <div class="mb-3">
                    <label for="heading2" class="form-label">Heading 2</label>
                    <input value="{{ $vision->heading2 ?? "" }}" 
                        type="text" 
                        class="form-control" 
                        name="heading2" 
                ...
                <div class="mb-3">
                    ...
                    <textarea 
                        class="form-control" 
                        name="description2" 
                        placeholder="Description 2" required>{{ $vision->description2 ?? "" }}</textarea>
                ...
                @if (isset($vision->image2))
                    <div class="mb-3">
                        ...
                        <br>
                        <img src="{{ asset('storage/' . $vision->image2) }}" alt="Uploaded Image" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                    </div>
                @endif
