                    ...
                    <form id="profileInfoForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="d-flex align-items-center mb-30">
                            <div class="profile-avatar-wrapper">
                                <img src="{{ auth()->user()->avatar
                                    ...
                                    : url('src/images/avatar/avatar-13.png') }}" alt="profile" id="profile_image_preview">
                                <label for="profile_image_input" class="profile-avatar-edit-btn">
                                    <i class="fa fa-camera"></i>
                                </label>
                                <input type="file" name="profile_image" id="profile_image_input" accept="image/png,image/jpeg,image/jpg" style="display:none">
                            </div>
                            <div class="ps-20">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control" name="date_of_birth" id="date_of_birth" value="{{ auth()->user()->date_of_birth ? \Carbon\Carbon::parse(auth()->user()->date_of_birth)->format('Y-m-d') : '' }}">
            ...
            <div class="box">
                <div class="box-body">
                    <div class="d-md-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-info" data-toggle="modal" data-target="#changeMobileModal">Change Number</button>
                    </div>
                </div>
            </div>
            ...
            <div class="box">
                <div class="box-body">
                    <div class="d-md-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-info" data-toggle="modal" data-target="#changeEmailModal">Change Email</button>
                    </div>
                </div>
            </div>
...
<!-- Change Mobile Modal -->
<div class="modal fade" id="changeMobileModal" tabindex="-1" aria-labelledby="changeMobileModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="mobile_step1">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="new_mobile_number" maxlength="10" placeholder="10 digit mobile number">
                ...
                <div id="mobile_step2" style="display:none">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="mobile_otp" maxlength="4" placeholder="4 digit OTP">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="verifyMobileOtpBtn" style="display:none">Verify</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="email_step2" style="display:none">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="email_otp" maxlength="4" placeholder="4 digit OTP">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="verifyEmailOtpBtn" style="display:none">Verify</button>
            </div>
        </div>
    </div>
</div>
