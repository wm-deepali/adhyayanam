...
<body>
    ...
    <div class="details">
        ...
        <div class="row"><strong>Subject:</strong> {{ $material->subject->name ?? 'N/A' }}</div>
        <div class="row"><strong>Chapter:</strong> {{ $material->chapter->name ?? 'N/A' }}</div>
        <div class="row"><strong>Topic:</strong> {{ $material->topic->name ?? 'N/A' }}</div>

        <div class="row"><strong>Material Type:</strong> {{ ucfirst(str_replace('_',' ', $material->material_type)) }}</div>
