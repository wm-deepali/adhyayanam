    ...
    <div class="bg-light rounded">
        <div class="card">
            <div class="card-body">
                ...
                <form id="form-question" action="{{ route('teacher.question.bank.import-questions') }}" method="POST"
                    ...
                    <div id="questions-container">
                        <div class="form-body">
                            ...
                            <div id="multiple_choice_div" style="">
                                <p>For reference (how to manage Multiple choice question in docx file) - <a
                                        href="{{ asset('question-samples/multiple_choice_word.docx') }}" download="">click
                                        here</a></p>
                                <p>For reference (how to manage Multiple choice question in xlsx file) - <a
                                        href="{{ asset('question-samples/multiple_choice_excel.xlsx') }}" download="">click
                                        here</a></p>
                            </div>
                            <div id="story_based_div" style="display:none;">
                                <p>For reference (how to manage Passage question in docx file) - <a
                                        href="{{ asset('question-samples/Passage_format.docx') }}" download="">click
                                        here</a></p>
                            </div>
                            <div id="subjective_div" style="display:none;">
                                <p>For reference (how to manage Subjective question in docx file) - <a
                                        href="{{ asset('question-samples/subjective_word.docx') }}" download="">click
                                        here</a></p>
                                <p>For reference (how to manage Subjective question in xlsx file) - <a
                                        href="{{ asset('question-samples/subjective_excel.xlsx') }}" download="">click
                                        here</a></p>
                            </div>
                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="file" class="form-control" name="file" id="file"
                                                accept=".docx, application/vnd.openxmlformats-officedocument.wordprocessingml.document, .xlsx, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">
